package com.dreamfirestudios.dreamCore.DreamfireRecipe;
...
public interface IDreamfireRecipe {
    //Default values used in all recipes
    RecipeType recipeType();
    ItemStack recipeResult();
    default String recipeName(){ return getClass().getSimpleName(); }
    default String nameSpace(){ return String.format("%s_%s", DreamCore.class.getSimpleName(), recipeName()).toLowerCase(); }
